...
import uk.gov.hmrc.sample_compose_fragments.data.repository.RepositoryImpl.Companion.BUTTON_ATOM
import uk.gov.hmrc.sample_compose_fragments.data.repository.RepositoryImpl.Companion.TEXT_ATOM
            ...
            HmrcTheme {
                Surface(
                    ...
                    ComponentListScreen(items = listItems, navigateTo = {
                        when (it.id) {
                            TEXT_ATOM -> findNavController().navigate(R.id.action_atomsFragment_to_textFragment)
                            BUTTON_ATOM -> findNavController().navigate(R.id.action_atomsFragment_to_buttonFragment)
                        }
                    })
                }
            }
