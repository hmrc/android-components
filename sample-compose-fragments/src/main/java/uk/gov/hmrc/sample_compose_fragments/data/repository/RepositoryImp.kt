...
class RepositoryImpl @Inject constructor() : Repository {
    ...
    override suspend fun getMoleculesList() = arrayListOf(
        ...
        ComponentMenuItem(MOLECULE_PASSWORD_INPUT_VIEW, R.string.molecules_password_input_view)
    )
    ...
    override suspend fun getOrganismsList() = arrayListOf(
        ...
        ComponentMenuItem(ORGANISM_MENU_PANEL_ROW_CARD_VIEW, R.string.organisms_menu_panel_row),
        ComponentMenuItem(ORGANISM_ICON_BUTTON_CARD_VIEW, R.string.organisms_icon_button_card),
        ComponentMenuItem(ORGANISM_SUMMARY_ROW_VIEW, R.string.organisms_summary_row),
    ...
    companion object {
        ...
        const val MOLECULE_PASSWORD_INPUT_VIEW = 16

        // ORGANISM
        const val ORGANISM_HEADLINE_CARD_VIEW = 1
        const val ORGANISM_PRIMARY_CARD_VIEW = 2
        const val ORGANISM_MENU_PANEL_ROW_CARD_VIEW = 3
        const val ORGANISM_ICON_BUTTON_CARD_VIEW = 4
        const val ORGANISM_SUMMARY_ROW_VIEW = 5
