 ...
 */
package uk.gov.hmrc.sample_compose_fragments.presentation.navigation
...
fun ComponentsBottomNavigation(navController: NavHostController) {
    NavigationBar(
        ...
        containerColor = HmrcTheme.colors.hmrcWhiteBackground
    ) {
...
fun ComponentsNavGraph(
    ...
    NavHost(navController, startDestination = NavigationScreen.Organisms.route, modifier) {
        composable(
            ...
            arguments = listOf(
                navArgument(NAV_ARG_TOP_APP_BAR_TITLE) {
                    defaultValue = NavigationScreen.Organisms.resourceId
                }
            )
        ...
        composable(
            ...
            arguments = listOf(
                navArgument(NAV_ARG_TOP_APP_BAR_TITLE) {
                    defaultValue = NavigationScreen.Molecules.resourceId
                }
            )
        ...
        composable(
            ...
            arguments = listOf(
                navArgument(NAV_ARG_TOP_APP_BAR_TITLE) {
                    defaultValue = NavigationScreen.Atoms.resourceId
                }
            )
