...
import uk.gov.hmrc.components.sample.databinding.FragmentWarningBinding

class WarningViewFragment : BaseComponentsFragment() {

    private var binding: FragmentWarningBinding by autoCleared()

    override fun provideToolbar() = ToolbarState(true, R.string.molecules_warning, true)
