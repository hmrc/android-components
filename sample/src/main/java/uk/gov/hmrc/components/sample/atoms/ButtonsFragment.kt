...
import uk.gov.hmrc.components.sample.databinding.FragmentButtonsBinding

class ButtonsFragment : BaseComponentsFragment() {

    private var binding: FragmentButtonsBinding by autoCleared()

    override fun provideToolbar() = ToolbarState(true, R.string.atoms_buttons, true)
