...
import uk.gov.hmrc.components.sample.databinding.FragmentSeparatedViewContainerBinding

class SeparatedViewContainerFragment : BaseComponentsFragment() {

    private var binding: FragmentSeparatedViewContainerBinding by autoCleared()

    override fun provideToolbar() = ToolbarState(true, R.string.organisms_separated_view_container, true)

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentSeparatedViewContainerBinding.inflate(inflater, container, false)
        return binding.root
    }
