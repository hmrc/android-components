...
import uk.gov.hmrc.components.sample.databinding.FragmentDividerBinding

class DividerFragment : BaseComponentsFragment() {

    private var binding: FragmentDividerBinding by autoCleared()

    override fun provideToolbar() = ToolbarState(true, R.string.atoms_divider, true)
