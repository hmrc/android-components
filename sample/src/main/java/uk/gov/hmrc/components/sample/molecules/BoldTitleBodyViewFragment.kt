...
import uk.gov.hmrc.components.sample.databinding.FragmentBoldBinding

class BoldTitleBodyViewFragment : BaseComponentsFragment() {

    private var binding: FragmentBoldBinding by autoCleared()

    override fun provideToolbar() = ToolbarState(true, R.string.molecules_bold, true)
